...
from DBSegment.nnunet.experiment_planning.utils import crop
from DBSegment.nnunet.paths import *
import shutil
from DBSegment.nnunet.utilities.task_name_id_conversion import convert_id_to_task_name
from DBSegment.nnunet.preprocessing.sanity_checks import verify_dataset_integrity
...
def main():
    ...
    search_in = join(DBSegment.nnunet.__path__[0], "experiment_planning")
