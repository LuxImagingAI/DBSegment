...
from DBSegment.nnunet.run.default_configuration import get_default_configuration
from DBSegment.nnunet.paths import default_plans_identifier
from DBSegment.nnunet.run.load_pretrained_weights import load_pretrained_weights
from DBSegment.nnunet.training.cascade_stuff.predict_next_stage import predict_next_stage
from DBSegment.nnunet.training.network_training.nnUNetTrainer import nnUNetTrainer
from DBSegment.nnunet.training.network_training.nnUNetTrainerCascadeFullRes import nnUNetTrainerCascadeFullRes
from DBSegment.nnunet.training.network_training.nnUNetTrainerV2_CascadeFullRes import nnUNetTrainerV2CascadeFullRes
...
def main():
    ...
    if network == "3d_cascade_fullres":
        ...
        assert issubclass(trainer_class,
                          nnUNetTrainer), "network_trainer was found but is not derived from DBSegment.nnunetTrainer"
