...
from DBSegment.nnunet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from DBSegment.nnunet.training.loss_functions.dice_loss import DC_and_CE_loss
from DBSegment.nnunet.training.network_training.network_trainer import NetworkTrainer
...
class nnUNetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        IMPORTANT: If you inherit from DBSegment.nnunetTrainer and the init args change then you need to redefine self.init_args
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(DBSegment.nnunet.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="DBSegment.nnunet.preprocessing")
        assert preprocessor_class is not None, "Could not find preprocessor %s in DBSegment.nnunet.preprocessing" % \
                                               preprocessor_name
