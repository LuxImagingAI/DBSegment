...
import argparse
from DBSegment.nnunet.preprocessing.preprocessing import resample_data_or_seg
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(DBSegment.nnunet.__path__[0], "training", "network_training")],
                                                trainerclass,
