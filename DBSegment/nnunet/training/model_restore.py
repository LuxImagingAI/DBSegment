...
def restore_model(pkl_file, checkpoint=None, train=False, fp16=None):
    ...
    init = info['init']
    name = info['name']
    search_in = join(DBSegment.nnunet.__path__[0], "training", "network_training")
    tr = recursive_find_python_class([search_in], name, current_module="DBSegment.nnunet.training.network_training")
